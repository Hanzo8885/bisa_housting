...
<style>
    ...
    .hobi-card:hover::before { transform: scaleX(1); }
    ...
    .hobi-quote blockquote em { color: var(--green); font-style: normal; }
    .hobi-quote cite { font-size: .85rem; color: var(--muted); }
</style>
@endpush
...
<div class="hobi-wrap">
    ...
    <span class="hobi-tag">Olahraga</span>
</div>
...
<div class="hobi-card">
    ...
    <span class="hobi-tag">Teknologi</span>
</div>
...
<div class="hobi-card">
    ...
    <span class="hobi-tag">Hiburan</span>
</div>
