        ...
        <tr>
            <td align="center">
                <table width="580" cellpadding="0" cellspacing="0" style="width:100%; max-width:580px;">
                    ...
                    <!-- Top accent bar -->
                    <tr>
                        <td style="height:3px; background:linear-gradient(90deg, #00C896 0%, #00E5B0 50%, #007A5E 100%); border-radius:3px 3px 0 0;"></td>
                    </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="vertical-align:middle;">
                                                    <!-- Ornamental box -->
                                                    <div style="width:56px; height:56px; border:1.5px solid #00C896; border-radius:6px; text-align:center; position:relative; display:inline-block;">
                                                        <!-- top-left corner -->
                                                        <span style="position:absolute; top:-5px; left:-5px; width:8px; height:8px; border-top:1.5px solid #00C896; border-left:1.5px solid #00C896; display:block;"></span>
                                                        <!-- top-right corner -->
                                                        <span style="position:absolute; top:-5px; right:-5px; width:8px; height:8px; border-top:1.5px solid #00C896; border-right:1.5px solid #00C896; display:block;"></span>
                                                        <!-- bottom-left corner -->
                                                        <span style="position:absolute; bottom:-5px; left:-5px; width:8px; height:8px; border-bottom:1.5px solid #00C896; border-left:1.5px solid #00C896; display:block;"></span>
                                                        <!-- bottom-right corner -->
                                                        <span style="position:absolute; bottom:-5px; right:-5px; width:8px; height:8px; border-bottom:1.5px solid #00C896; border-right:1.5px solid #00C896; display:block;"></span>
                                                        <!-- Top ornament -->
                                                        <div style="font-size:9px; color:#00C896; line-height:1; margin-top:5px; letter-spacing:1px;">✦</div>
                                                        <!-- Initial -->
                                                        <div style="font-family: Georgia, 'Times New Roman', serif; font-size:22px; font-weight:700; color:#ffffff; line-height:1; margin-top:1px; letter-spacing:1px;">A</div>
                                                        <!-- Bottom ornament -->
                                                        <div style="font-size:9px; color:#00C896; line-height:1; margin-top:1px; letter-spacing:1px;">✦</div>
                                                    </div>
                                                </td>
                                    ...
                                    <td align="right" style="vertical-align:middle;">
                                        <!-- Badge -->
                                        <span style="background:#00C89618; color:#00C896; font-size:11px; font-weight:600; letter-spacing:0.5px; padding:5px 12px; border-radius:20px; border:1px solid #00C89635; white-space:nowrap;">● PESAN BARU</span>
                                    </td>
                                </tr>
                            </table>

                            <!-- Divider -->
                            <div style="height:1px; background:linear-gradient(90deg, #1e1e1e 0%, #2a2a2a 50%, #1e1e1e 100%); margin: 24px 0 20px 0;"></div>
                    ...
                    <tr>
                        <td style="background:#111111; padding: 0 40px 36px 40px; border-left:1px solid #1e1e1e; border-right:1px solid #1e1e1e;">
                            ...
                            <div style="margin-top:24px;">
                                ...
                                <div style="background:#161616; border:1px solid #222222; border-radius:14px; padding:22px 24px; position:relative;">
                                    <!-- Quote mark accent -->
                                    <div style="font-size:48px; color:#00C89620; font-family:Georgia, serif; line-height:1; position:absolute; top:8px; left:20px; font-weight:700;">"</div>
                                    <p style="font-size:14px; color:#cccccc; line-height:1.85; margin:0; padding-top:20px;">{{ $pesan }}</p>
                                </div>
                            </div>

                            <!-- Reply CTA -->
                            <div style="text-align:center; margin-top:32px;">
                                <a href="mailto:{{ $email }}" style="background:linear-gradient(135deg,#00C896,#00a87e); color:#0a0a0a; padding:14px 36px; border-radius:12px; text-decoration:none; font-weight:700; font-size:14px; display:inline-block; letter-spacing:-0.2px;">
                                    Balas Pesan &nbsp;↗
                                </a>
