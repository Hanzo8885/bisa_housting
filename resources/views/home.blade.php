...
<section class="about-preview" id="about">
    <div style="flex:1; min-width:280px;">
        ...
        <h2>Membangun Sistem Berbasis Kode dan Logika.</h2>
        <p>
            Bersekolah di SMKN 2 Kota Sukabumi, jurusan RPL Sukabumi membawa saya mendalami logika pemrograman backend. Selain aktif mengembangkan aplikasi berbasis web dan software desktop, saya juga menyelaraskan fungsi sistem dengan tampilan antarmuka yang ramah pengguna.
        </p>
        <div class="stats-row">
            <div>
